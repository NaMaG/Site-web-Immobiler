...
$show_status_tab = $keyword_enable = $title_enable = $address_enable = $city_enable = $type_enable = $status_enable = $bedrooms_enable =
...
$request_paged = isset($_GET['paged']) ? absint(wp_unslash($_GET['paged'])) : 1;
